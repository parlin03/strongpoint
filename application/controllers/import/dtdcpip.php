...
class Dtdcpip extends MY_Controller
{
    ...
    */
    function index()
    {
        ...
        $data['table_list'] = $this->import_model->fetch_dtdcpip();
        ...
        $this->load->view('import/dtdcpip/content', $data);
