...
class Jaringbpum extends MY_Controller
{
    ...
    */
    function index()
    {
        $data['title'] = 'Jaring Program BPUM UMKM';
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array(); //arraynya sebaris

        $data['table_list'] = $this->import_model->fetch_jaringbpum();
        ...
        $this->load->view('import/jaringbpum/content', $data);
