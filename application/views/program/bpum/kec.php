        ...
        <div class="container-fluid">
            <div class="row mb-2 ju">
                <div class="col-sm-12">
                    ...
                    <br><a href="<?= base_url('program/bpum/'); ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        var options = {
            ...
            title: {
                text: 'Sebaran BPUM UMKM Kecamatan ' + '<?= ucfirst($this->uri->segment(4)); ?>'
            },
            tooltip: {
                formatter: function() {
        ...
        $.getJSON("<?php echo site_url('program/bpum/GraphKec_list/'); ?>", function(json) {
...
<script>
    $(function() {
        $("#example1").DataTable({
            ...
            "buttons": ["copy", "csv", {
                extend: 'excel',
                title: 'Sebaran BPUM UMKM Kecamatan ' + '<?= ucfirst($this->uri->segment(4)); ?>',
                filename: 'Sebaran BPUM UMKM Kecamatan ' + '<?= ucfirst($this->uri->segment(4)); ?>'
            }, {
                extend: 'pdf',
                title: 'Sebaran BPUM UMKM Kecamatan ' + '<?= ucfirst($this->uri->segment(4)); ?>',
                filename: 'Sebaran BPUM UMKM Kecamatan ' + '<?= ucfirst($this->uri->segment(4)); ?>',
