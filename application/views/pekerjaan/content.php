            ...
            <tbody>
                <?php foreach ($Bpum_list as $key => $bpum) { ?>
                    <tr class="text-center">
                        ...
                        <td class="border"><?= $bpum['pekerjaan'] ?></td>
                        <td class="border"><?= $bpum['jenis_pekerjaan'] ?></td>
                        <td class="border"><?= $bpum['pagu_anggaran'] ?></td>
                        <td class="border"><?= $bpum['opd'] ?></td>
                        <td class="border"><?= $bpum['rekanan'] ?></td>
                        <td class="border"><?= $bpum['status'] ?></td>
                    </tr>
                <?php } ?>
...
<!-- Load Modal Views -->
<?php
$this->load->view('pekerjaan/modal-export-excel');
$this->load->view('pekerjaan/modal-import-excel');
?>
