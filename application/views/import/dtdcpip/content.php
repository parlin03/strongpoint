            ...
            <tbody>
                <?php foreach ($table_list as $key => $tbl) { ?>
                    <tr class="text-center">
                        ...
                        <td class="border"><?= $tbl['kelas'] ?></td>
                        <td class="border"><?= $tbl['sekolah'] ?></td>
...
<!-- Load Modal Views -->
<?php
$this->load->view('import/dtdcpip/modal-export-excel');
$this->load->view('import/dtdcpip/modal-import-excel');
?>
